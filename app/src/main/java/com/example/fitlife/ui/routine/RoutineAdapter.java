...
public class RoutineAdapter extends RecyclerView.Adapter<RoutineAdapter.RoutineViewHolder> {
    ...
    class RoutineViewHolder extends RecyclerView.ViewHolder {
        private final TextView tvRoutineName, tvExercisePreview, tvFullEquipment, tvLocationNameSmall;
        private final CheckBox cbCompleted;
        private final ImageButton ibMenu;
        private final LinearLayout layoutExpandable, layoutLocationBadge, layoutFullLocation, containerFullExercises;
        ...
        public RoutineViewHolder(@NonNull View itemView) {
            ...
            containerFullExercises = itemView.findViewById(R.id.containerFullExercises);
        ...
        private void showInAppSmsDialog(WorkoutRoutine routine) {
            ...
            btnSend.setOnClickListener(v -> {
                ...
                if (phone.isEmpty()) { Toast.makeText(context, "Enter phone", Toast.LENGTH_SHORT).show(); return; }
                try {
